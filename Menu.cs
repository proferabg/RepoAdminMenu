...
namespace RepoAdminMenu {
    internal class Menu {
        ...
        private static void openPlayerUpgrades() {
            ...
            addIntSlider(upgradesMenu, "Crouch Rest", "", (v) => { PlayerUtil.upgrade(avatar, "playerUpgradeCrouchRest", v); PunManager.instance.UpdateCrouchRestRightAway(selectedPlayerId, 1); }, 0, Configuration.MaxUpgradeLevel.Value, PlayerUtil.getUpgradeLevel("playerUpgradeCrouchRest", avatar));
            addIntSlider(upgradesMenu, "Health", "", (v) => { PlayerUtil.upgrade(avatar, "playerUpgradeHealth", v); PunManager.instance.UpdateHealthRightAway(selectedPlayerId, 1); }, 0, Configuration.MaxUpgradeLevel.Value, PlayerUtil.getUpgradeLevel("playerUpgradeHealth", avatar));
            addIntSlider(upgradesMenu, "Jump", "", (v) => { PlayerUtil.upgrade(avatar, "playerUpgradeExtraJump", v); PunManager.instance.UpdateExtraJumpRightAway(selectedPlayerId, 1); }, 0, Configuration.MaxUpgradeLevel.Value, PlayerUtil.getUpgradeLevel("playerUpgradeExtraJump", avatar));
            addIntSlider(upgradesMenu, "Launch", "", (v) => { PlayerUtil.upgrade(avatar, "playerUpgradeLaunch", v); PunManager.instance.UpdateTumbleLaunchRightAway(selectedPlayerId, 1); }, 0, Configuration.MaxUpgradeLevel.Value, PlayerUtil.getUpgradeLevel("playerUpgradeLaunch", avatar));
            addIntSlider(upgradesMenu, "Map Player Count", "", (v) => { PlayerUtil.upgrade(avatar, "playerUpgradeMapPlayerCount", v); PunManager.instance.UpdateMapPlayerCountRightAway(selectedPlayerId, 1); }, 0, Configuration.MaxUpgradeLevel.Value, PlayerUtil.getUpgradeLevel("playerUpgradeMapPlayerCount", avatar));
            addIntSlider(upgradesMenu, "Range", "", (v) => { PlayerUtil.upgrade(avatar, "playerUpgradeRange", v); PunManager.instance.UpdateGrabRangeRightAway(selectedPlayerId, 1); }, 0, Configuration.MaxUpgradeLevel.Value, PlayerUtil.getUpgradeLevel("playerUpgradeRange", avatar));
            addIntSlider(upgradesMenu, "Speed", "", (v) => { PlayerUtil.upgrade(avatar, "playerUpgradeSpeed", v); PunManager.instance.UpdateSprintSpeedRightAway(selectedPlayerId, 1); }, 0, Configuration.MaxUpgradeLevel.Value, PlayerUtil.getUpgradeLevel("playerUpgradeSpeed", avatar));
            addIntSlider(upgradesMenu, "Stamina", "", (v) => { PlayerUtil.upgrade(avatar, "playerUpgradeStamina", v); PunManager.instance.UpdateEnergyRightAway(selectedPlayerId, 1); }, 0, Configuration.MaxUpgradeLevel.Value, PlayerUtil.getUpgradeLevel("playerUpgradeStamina", avatar));
            addIntSlider(upgradesMenu, "Strength", "", (v) => { PlayerUtil.upgrade(avatar, "playerUpgradeStrength", v); PunManager.instance.UpdateGrabStrengthRightAway(selectedPlayerId, 1); }, 0, Configuration.MaxUpgradeLevel.Value, PlayerUtil.getUpgradeLevel("playerUpgradeStrength", avatar));
            addIntSlider(upgradesMenu, "Throw", "", (v) => { PlayerUtil.upgrade(avatar, "playerUpgradeThrow", v); PunManager.instance.UpdateThrowStrengthRightAway(selectedPlayerId, 1); }, 0, Configuration.MaxUpgradeLevel.Value, PlayerUtil.getUpgradeLevel("playerUpgradeThrow", avatar));
            addIntSlider(upgradesMenu, "Tumble Wings", "", (v) => { PlayerUtil.upgrade(avatar, "playerUpgradeTumbleWings", v); PunManager.instance.UpdateTumbleWingsRightAway(selectedPlayerId, 1); }, 0, Configuration.MaxUpgradeLevel.Value, PlayerUtil.getUpgradeLevel("playerUpgradeTumbleWings", avatar));
